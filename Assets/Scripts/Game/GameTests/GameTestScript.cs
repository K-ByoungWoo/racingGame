...
public class GameTestScript
{
    ...
    public IEnumerator GameTestScriptWithEnumeratorPasses()
    {
        ...
        Assert.IsNotNull(_carController, "CarController Object is Null");
        
        // 게임 제어 관련 버튼 확인
        _leftMoveButton = GameObject.Find("LeftMoveButton");
        Assert.IsNotNull(_leftMoveButton, "LeftButton Object is Null");
        _rightMoveButton = GameObject.Find("RightMoveButton");
        Assert.IsNotNull(_rightMoveButton, "RightButton Object is Null");
